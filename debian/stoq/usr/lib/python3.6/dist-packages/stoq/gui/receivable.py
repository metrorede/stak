...
class ReceivableApp(BaseAccountWindow):
    ...
    def create_actions(self):
        ...
        actions = [
            ...
            ('Receive222', Gtk.STOCK_APPLY, _('Receive222'),
             group.get('payment_receive222'),
             _('Receive the selected payments')),
    ...
    def get_domain_options(self):
        options = [
            ...
            ('fa-check-symbolic', _('Receive222'), 'receivable.Receive222', True),
    ...
    def _update_widgets(self):
        ...
        self.set_sensitive([self.Receive222], self._can_receive(selected))
